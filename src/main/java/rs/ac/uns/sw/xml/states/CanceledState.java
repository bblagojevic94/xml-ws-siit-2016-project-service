...
public class CanceledState implements State {
    ...
    public CanceledState(LawServiceXML lawServiceXML, AmendmentsServiceXML amendmentsServiceXML) {
    ...
    public ResponseEntity<?> suggestLaw(Law law, Parliament parliament) {
        return wrongState(StateConstants.ParliamentStates.CANCELED_STATE);
    }
